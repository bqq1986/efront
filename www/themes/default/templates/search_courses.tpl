    ...
    *}
            <td align="center">
                {if $user.user_type != 'administrator'}
                    <a href="{$smarty.session.s_type}.php?ctg=personal&user={$user.login}&op=user_form&popup=1&printable=1" target = "_new"><img src='images/16x16/printer.png' title=  '{$smarty.const._PRINTPREVIEW}' alt = '{$smarty.const._PRINTPREVIEW}' border='0' /></a>
                {else}
