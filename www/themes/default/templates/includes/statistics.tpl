        ...
        <table class = "statisticsPanel">
            <tr><td>
                {if $smarty.const.G_VERSIONTYPE == 'enterprise'} {* #cpp#ifdef ENTERPRISE *}
                    {eF_template_printBlock title = $smarty.const._STATISTICS columns = 3 links  =$T_STATISTICS_OPTIONS image = '32x32/options.png' help = 'Reports' groups = $T_REPORTS_GROUPS}
                {else} {* #cpp#else *}
