                    ...
                    {if !isset($T_CURRENT_USER->coreAccess.configuration) || $T_CURRENT_USER->coreAccess.configuration == 'change'}
                        <div class = "headerTools">
                            <span>
                                ...
                                <a href = "javascript:void(0)"  title = "{$smarty.const._ADDLANGUAGE}" onclick = "eF_js_showDivPopup(event, '{$smarty.const._ADDLANGUAGE}', 0, 'language_table');$('language_name').value = '';$('language_translation').value = '';$('selected_language').value = '';$('language_rtl').checked = '';">{$smarty.const._ADDLANGUAGE}</a>
                            </span>
                        </div>
