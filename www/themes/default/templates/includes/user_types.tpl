							...
							<tr>
								...
								<form {$T_USERTYPES_FORM.attributes}>
									...
									<table class = "formElements">
										<tr>
											<td class = "labelCell">{$T_USERTYPES_FORM.name.label}:&nbsp;</td>
											<td class = "elementCell">{$T_USERTYPES_FORM.name.html}</td>
										</tr>
                                        
										{if $T_USERTYPES_FORM.name.error}
											<tr>
												<td></td>
												<td class = "formError">{$T_USERTYPES_FORM.name.error}</td>
											</tr>
										{/if}
                                        
										<tr>
											<td class = "labelCell">{$T_USERTYPES_FORM.basic_user_type.label}:&nbsp;</td>
											<td class = "elementCell">{$T_USERTYPES_FORM.basic_user_type.html}</td>
										</tr>
										
										{if $T_USERTYPES_FORM.basic_user_type.error}
										<tr>
											<td></td>
											<td class = "formError">{$T_USERTYPES_FORM.basic_user_type.error}</td>
										</tr>
										{/if}
                                        ...
                                        <tr>
											<td class = "labelCell">{$T_USERTYPES_FORM.core_access.$option.label}:&nbsp;</td>
											<td class = "elementCell">{$T_USERTYPES_FORM.core_access.$option.html}</td>
										</tr>
											
										{if $T_USERTYPES_FORM.core_access.$option.error}
										<tr>
											<td></td>
											<td class = "formError">{$T_USERTYPES_FORM.core_access.$option.error}</td>
										</tr>
										{/if}
										...
										<tr>
											<td class = "labelCell">{$smarty.const._SETALLTO}:&nbsp;</td>
                                        ...
                                        <tr>
											<td></td>
											<td class = "submitCell">{$T_USERTYPES_FORM.submit_type.html}</td>
										</tr>
									</table>
								</form>
								</td>
				...
				{else}
					{capture name = 't_roles_code'}
						...
						<table style = "width:100%" class = "sortedTable" sortBy = "0">
							<tr class = "topTitle">
								<td class = "topTitle" name="name">{$smarty.const._TYPENAME}</td>
								<td class = "topTitle" name="basic_user_type">{$smarty.const._BASICUSERTYPE}</td>
