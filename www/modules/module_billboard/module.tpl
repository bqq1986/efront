...
{capture name = 't_billboard_list_code'}
    ...
    <form {$T_BILLBOARD_FORM.attributes}>
        ...
        <table>
			...
			<a title="{$smarty.const._UPLOADFILESANDIMAGES}" href = "{$smarty.server.PHP_SELF}?ctg=file_manager&popup=1" onclick = "eF_js_showDivPopup(event, '{$smarty.const._UPLOADFILESANDIMAGES}', 3)" target = "POPUP_FRAME"  style = "vertical-align:middle"><span  style = "vertical-align:middle">{$smarty.const._UPLOADFILESANDIMAGES}</span></a>
