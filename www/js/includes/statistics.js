...
if ($('autocomplete_lessons')) { 
	new Ajax.Autocompleter("autocomplete_l", 
...
if ($('course_choices_not_certificated')) { 
	new Ajax.Autocompleter("autocomplete_course_not_certificated", 
						   "course_choices_not_certificated", 
						   "ask.php?ask_type=courses", {paramName: "preffix",
											   afterUpdateElement : function (t, li) {$('course_id_not_certificated').value=li.id;}, 
											   indicator : "busy_course_not_certificated"}); 
}
if ($('course_choices_already_expired_for')) { 
	new Ajax.Autocompleter("autocomplete_course_already_expired_for", 
						   "course_choices_already_expired_for", 
						   "ask.php?ask_type=courses", {paramName: "preffix",
											   afterUpdateElement : function (t, li) {$('course_id_already_expired_for').value=li.id;}, 
											   indicator : "busy_course_already_expired_for"}); 
}
if ($('course_choices_expire_for')) { 
	new Ajax.Autocompleter("autocomplete_course_expire_for", 
						   "course_choices_expire_for", 
						   "ask.php?ask_type=courses", {paramName: "preffix",
											   afterUpdateElement : function (t, li) {$('course_id_expire_for').value=li.id;}, 
											   indicator : "busy_course_expire_for"}); 
}
