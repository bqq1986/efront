		...
		init : function(ed, url) {
			...
			ed.addCommand('mceSaveTemplate', function() {
				ed.windowManager.open({
					...
					width : 550 + parseInt(ed.getLang('save_template.delta_width', 0)),
					height : 560 + parseInt(ed.getLang('save_template.delta_height', 0)),
					inline : 1
				}, {
					plugin_url : url
				});
			...
			// Register buttons
			ed.addButton('save_template', {title : 'save_template.save_template_title', cmd : 'mceSaveTemplate'});
		},
