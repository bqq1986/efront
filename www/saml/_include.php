<?php
/*
require_once("../../libraries/Efront/Controller/MainController.php");

try {

	$mc = new Efront\Controller\MainController();
	$mc->setup();
...
*/
$path = dirname(dirname(dirname(__FILE__))).'/libraries/external/simplesamlphp';
